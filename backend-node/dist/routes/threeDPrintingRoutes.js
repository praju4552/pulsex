...
const ThreeDController = __importStar(require("../controllers/threeDPrintingController"));
...
router.get('/download/:fileId', auth_1.authenticateToken, ThreeDController.downloadFile);
