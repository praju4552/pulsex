 ...
 * @category Node
 */
export declare const DRILL_HEADER = "drillHeader";
/**
 ...
 * @category Node
 */
export type ChildNode = Comment | DrillHeader | Done | Units | CoordinateFormat | ToolDefinition | ToolMacro | ToolChange | InterpolateMode | RegionMode | QuadrantMode | LoadPolarity | StepRepeat | Graphic | Unimplemented;
/**
